%%Danny's newest code
%%modified  Mar 8, 2017
%This one even simplifies the analysis by looking at particles crossing
%along just one single edge
...
file = 'E:\Bryant_Lab_Data\Good\20170115_ch02_PRC117_1-4dilution_2mMATP_2mMMag_1mspf_600frames_150Xmag 05.tif';
...
rotz(:,:,1) = [0.9547 0.2975 0; -0.2975 0.9547 0; 0 0 1];
rotz(:,:,2) = [0.8506 -0.5259 0; 0.5259 0.8506 0; 0 0 1];
rotznen = -1*rotz;
rotznen(:,3,:) = -1*rotznen(:,3,:);
...
%                 exitdatay = traj(locz(loc_crs):locz(end),1);
            ...
            temprot = rotznen(:,:,boxnum);
            temprotnen = rotz(:,:,boxnum);
